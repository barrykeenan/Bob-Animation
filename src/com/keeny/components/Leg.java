...
public class Leg extends BranchGroup {
    ...
    private TransformGroup upperLeg() {
        ...
        //Add the hip shape
        hipTG.addChild(new Sphere(0.2f, textured, 20, materials.cords()));
        ...
        upperLegTG.addChild(new Cylinder(0.2f, 0.4f, textured, materials.cords()));
        ...
        upperLeg2TG.addChild(new Cylinder(0.19f, 0.4f, textured, materials.cords()));
    ...
    private TransformGroup lowerLeg() {
        ...
        //Add the knee shape
        kneeTG.addChild(new Sphere(0.19f, textured, 20, materials.cords()));
        ...
        lowerLegTG.addChild(new Cylinder(0.19f, 0.4f, textured, materials.cords()));
        ...
        lowerLeg2TG.addChild(new Cylinder(0.21f, 0.6f, textured, materials.cords()));
    ...
    private TransformGroup foot() {
        ...
        topTG.addChild(new Sphere(0.27f, normal, materials.shoe()));
        ...
        soleTG.addChild(new Cylinder(0.27f, 0.07f, normal, materials.shoe()));
